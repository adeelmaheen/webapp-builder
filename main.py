...
# Background model preload function
def preload_models():
    client = HuggingFaceClient()
    try:
        client.captioner._load_model()
        client.generator._load_model()
        print("Models preloaded successfully.")
    except Exception as e:
        print(f"Error preloading models: {e}")

# Start preloading in a background daemon thread so app startup is fast
